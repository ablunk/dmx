...
public class EmfSdlPackageImpl extends EPackageImpl implements EmfSdlPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link EmfSdlPackage#eINSTANCE} when that field is accessed.
	...
	public static EmfSdlPackage init() {
		...
		EmfSdlPackageImpl theEmfSdlPackage = (EmfSdlPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EmfSdlPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new EmfSdlPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(EmfSdlPackage.eNS_URI, theEmfSdlPackage);
