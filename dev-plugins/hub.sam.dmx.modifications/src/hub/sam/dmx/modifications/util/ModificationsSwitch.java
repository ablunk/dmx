 ...
 * @generated
 */
public class ModificationsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModificationsPackage.MODIFICATIONS_RECORD: {
				ModificationsRecord modificationsRecord = (ModificationsRecord)theEObject;
				T result = caseModificationsRecord(modificationsRecord);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModificationsPackage.MODIFICATION: {
				Modification modification = (Modification)theEObject;
				T result = caseModification(modification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModificationsPackage.SUBSTITUTION: {
				Substitution substitution = (Substitution)theEObject;
				T result = caseSubstitution(substitution);
				if (result == null) result = caseModification(substitution);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModificationsPackage.ADDITION: {
				Addition addition = (Addition)theEObject;
				T result = caseAddition(addition);
				if (result == null) result = caseModification(addition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseModificationsRecord(ModificationsRecord object) {
		return null;
	}
