 ...
 * @generated
 */
public class BfPackageImpl extends EPackageImpl implements BfPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see hub.sam.edu.modsoft.bfmodel.bf.BfPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BfPackageImpl() {
		super(eNS_URI, BfFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link BfPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BfPackage init() {
		if (isInited) return (BfPackage)EPackage.Registry.INSTANCE.getEPackage(BfPackage.eNS_URI);

		// Obtain or create and register package
		BfPackageImpl theBfPackage = (BfPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BfPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BfPackageImpl());
		...
		theBfPackage.initializePackageContents();
		...
		EPackage.Registry.INSTANCE.put(BfPackage.eNS_URI, theBfPackage);
		return theBfPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getBox_OwnedBoxes() {
	 ...
	 * @generated
	 */
	public EReference getBox_Owner() {
	 ...
	 * @generated
	 */
	public EReference getBox_Flows() {
	 ...
	 * @generated
	 */
	public EReference getBox_IncomingFlows() {
	 ...
	 * @generated
	 */
	public EReference getBox_OutgoingFlows() {
	 ...
	 * @generated
	 */
	public EReference getFlow_SourceBox() {
	 ...
	 * @generated
	 */
	public EReference getFlow_TargetBox() {
	 ...
	 * @generated
	 */
	public BfFactory getBfFactory() {
		return (BfFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(boxEClass, BOX__OWNED_BOXES);
		createEReference(boxEClass, BOX__OWNER);
		...
		createEReference(flowEClass, FLOW__TARGET_BOX);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getBox_OwnedBoxes(), this.getBox(), this.getBox_Owner(), "ownedBoxes", null, 0, -1, Box.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBox_Owner(), this.getBox(), this.getBox_OwnedBoxes(), "owner", null, 0, 1, Box.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFlow_TargetBox(), this.getBox(), this.getBox_IncomingFlows(), "targetBox", null, 1, 1, Flow.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
