  ...
  public String genEClass(final EClass eClass) {
    String _xblockexpression = null;
    {
      ...
      if (_not) {
        ...
        _builder_1.newLine();
        _builder_1.newLine();
        _builder_1.append("class EListIterator {");
        _builder_1.newLine();
        _builder_1.append("\t");
        _builder_1.append("bindings {");
        _builder_1.newLine();
        ...
        _builder_1.newLine();
        _builder_1.append("\t");
        _builder_1.append("EObject next() abstract;");
        _builder_1.newLine();
        _builder_1.append("\t");
        ...
        _builder_1.newLine();
        _builder_1.newLine();
        _builder_1.append("boolean add(EObject e) abstract;");
        _builder_1.newLine();
        _builder_1.append("boolean add(int index, EObject e) abstract;");
        _builder_1.newLine();
        _builder_1.append("void clear() abstract;");
        _builder_1.newLine();
        _builder_1.append("boolean contains(EObject e) abstract;");
        _builder_1.newLine();
        _builder_1.append("int size() abstract;");
        _builder_1.newLine();
        _builder_1.append("EObject get(int index) abstract;");
        _builder_1.newLine();
        _builder_1.append("int indexOf(EObject e) abstract;");
        _builder_1.newLine();
        _builder_1.append("boolean isEmpty() abstract;");
        _builder_1.newLine();
        _builder_1.append("EObject remove(int index) abstract;");
        _builder_1.newLine();
        _builder_1.append("boolean remove(EObject e) abstract;");
        _builder_1.newLine();
        _builder_1.append("EObject set(int index, EObject e) abstract;");
        _builder_1.newLine();
        _builder_1.append("EObject array[] toArray() abstract;");
        _builder_1.newLine();
        _builder_1.append("EListIterator iterator() abstract;");
        _builder_1.newLine();
        _builder_1.append("}");
        _builder_1.newLine();
        _builder_1.newLine();
        ...
        _builder_1.newLine();
        _builder_1.append("\t");
        _builder_1.append("EList eContents() abstract;");
        _builder_1.newLine();
        _builder_1.append("\t");
        _builder_1.append("EList eAllContents() abstract;");
        _builder_1.newLine();
        _builder_1.append("\t");
