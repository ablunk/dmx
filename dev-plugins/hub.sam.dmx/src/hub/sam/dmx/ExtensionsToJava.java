...
/**
 * Entry point of the 'ExtensionsToJava' generation module.
 *
 * @generated
 */
@Deprecated
public class ExtensionsToJava extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/hub/sam/dmx/ExtensionsToJava";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "extensionsToJava" };
     ...
     * @generated
     */
    public ExtensionsToJava(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public ExtensionsToJava(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                ExtensionsToJava generator = new ExtensionsToJava(modelURI, folder, arguments);
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(DblPackage.class)) {
        	resourceSet.getPackageRegistry().put(DblPackage.eNS_URI, DblPackage.eINSTANCE);
        }
        else {
        	resourceSet.getPackageRegistry().put("/hub.sam.dmx/resources/dbl.ecore", DblPackage.eINSTANCE);
        }
