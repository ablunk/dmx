...
public class PositionWithNegative extends Position {
	...
	public PositionWithNegative(Position position) {
		this(position.getOffset(), position.getLength());
	}
	 ...
	 */
	public PositionWithNegative(int offset) {
		this(offset, 0);
	}
	 ...
	 */
	public PositionWithNegative(int offset, int length) {
		this.offset= offset;
		this.length= length;
	}
	 ...
	 */
	protected PositionWithNegative() {
	}
