...
@Deprecated
public class SequentialModificationApplier {
	
	private static final Logger logger = Logger.getLogger(SequentialModificationApplier.class.getName());

	private final List<Modification> sortedModifications = new ArrayList<Modification>();
	private final String originalText;
	private StringBuffer workingText;
	
	public SequentialModificationApplier(EList<Modification> unsortedModifications, String originalText) {
