...
/**
 * Entry point of the 'BaseToJava' generation module.
 *
 * @generated
 */
public class BaseToJava extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/hub/sam/dmx/BaseToJava";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "baseToJava" };
     ...
     * @generated
     */
    public BaseToJava(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public BaseToJava(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                BaseToJava generator = new BaseToJava(modelURI, folder, arguments);
