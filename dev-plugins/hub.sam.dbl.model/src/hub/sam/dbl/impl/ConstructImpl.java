 ...
 * <ul>
 *   <li>{@link hub.sam.dbl.impl.ConstructImpl#getConcreteSyntax <em>Concrete Syntax</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstructImpl extends NamedExtensibleImpl implements Construct {
	...
	public void setConcreteSyntax(String newConcreteSyntax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.CONSTRUCT__CONCRETE_SYNTAX, oldConcreteSyntax, concreteSyntax));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DblPackage.CONSTRUCT__CONCRETE_SYNTAX:
