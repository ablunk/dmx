...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Syntax Symbol Classifier</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class SyntaxSymbolClassifierImpl extends NamedElementImpl implements SyntaxSymbolClassifier {
	/**
	 ...
	 * @generated
	 */
	protected SyntaxSymbolClassifierImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DblPackage.Literals.SYNTAX_SYMBOL_CLASSIFIER;
	}
	...
	public NotificationChain basicSetExpandExpr(ExpandExpr newExpandExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DblPackage.SYNTAX_SYMBOL_CLASSIFIER__EXPAND_EXPR, oldExpandExpr, newExpandExpr);
	...
	public void setExpandExpr(ExpandExpr newExpandExpr) {
		if (newExpandExpr != expandExpr) {
			...
			if (expandExpr != null)
				msgs = ((InternalEObject)expandExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DblPackage.SYNTAX_SYMBOL_CLASSIFIER__EXPAND_EXPR, null, msgs);
			if (newExpandExpr != null)
				msgs = ((InternalEObject)newExpandExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DblPackage.SYNTAX_SYMBOL_CLASSIFIER__EXPAND_EXPR, null, msgs);
			msgs = basicSetExpandExpr(newExpandExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.SYNTAX_SYMBOL_CLASSIFIER__EXPAND_EXPR, newExpandExpr, newExpandExpr));
	}
	...
	public void setConcreteSyntax(String newConcreteSyntax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.SYNTAX_SYMBOL_CLASSIFIER__CONCRETE_SYNTAX, oldConcreteSyntax, concreteSyntax));
	}
	...
	public void setInstanceOfExtensionDefinition(boolean newInstanceOfExtensionDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.SYNTAX_SYMBOL_CLASSIFIER__INSTANCE_OF_EXTENSION_DEFINITION, oldInstanceOfExtensionDefinition, instanceOfExtensionDefinition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DblPackage.SYNTAX_SYMBOL_CLASSIFIER__EXPAND_EXPR:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DblPackage.SYNTAX_SYMBOL_CLASSIFIER__CONCRETE_SYNTAX:
				return getConcreteSyntax();
			case DblPackage.SYNTAX_SYMBOL_CLASSIFIER__INSTANCE_OF_EXTENSION_DEFINITION:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Construct.class) {
			switch (derivedFeatureID) {
				case DblPackage.SYNTAX_SYMBOL_CLASSIFIER__EXPAND_EXPR: return DblPackage.CONSTRUCT__EXPAND_EXPR;
				default: return -1;
			}
		}
		if (baseClass == ExtensibleElement.class) {
			switch (derivedFeatureID) {
				case DblPackage.SYNTAX_SYMBOL_CLASSIFIER__CONCRETE_SYNTAX: return DblPackage.EXTENSIBLE_ELEMENT__CONCRETE_SYNTAX;
				case DblPackage.SYNTAX_SYMBOL_CLASSIFIER__INSTANCE_OF_EXTENSION_DEFINITION: return DblPackage.EXTENSIBLE_ELEMENT__INSTANCE_OF_EXTENSION_DEFINITION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Construct.class) {
			switch (baseFeatureID) {
				case DblPackage.CONSTRUCT__EXPAND_EXPR: return DblPackage.SYNTAX_SYMBOL_CLASSIFIER__EXPAND_EXPR;
				default: return -1;
			}
		}
		if (baseClass == ExtensibleElement.class) {
			switch (baseFeatureID) {
				case DblPackage.EXTENSIBLE_ELEMENT__CONCRETE_SYNTAX: return DblPackage.SYNTAX_SYMBOL_CLASSIFIER__CONCRETE_SYNTAX;
				case DblPackage.EXTENSIBLE_ELEMENT__INSTANCE_OF_EXTENSION_DEFINITION: return DblPackage.SYNTAX_SYMBOL_CLASSIFIER__INSTANCE_OF_EXTENSION_DEFINITION;
				default: return -1;
			}
		}
