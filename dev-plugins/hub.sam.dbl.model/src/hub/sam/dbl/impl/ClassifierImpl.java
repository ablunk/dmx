...
public abstract class ClassifierImpl extends TypeImpl implements Classifier {
	...
	protected EClass eStaticClass() {
		return DblPackage.Literals.CLASSIFIER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.CLASSIFIER__NAME, oldName, name));
	}
	...
	public EList<NativeBinding> getBindings() {
		if (bindings == null) {
			bindings = new EObjectContainmentEList<NativeBinding>(NativeBinding.class, this, DblPackage.CLASSIFIER__BINDINGS);
		}
		return bindings;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ReferableRhsType.class) {
			switch (derivedFeatureID) {
				default: return -1;
			}
		}
