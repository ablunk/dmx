 ...
 * <ul>
 *   <li>{@link hub.sam.dbl.impl.ClassifierImpl#getArrayDimensions <em>Array Dimensions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ClassifierImpl extends NamedElementImpl implements Classifier {
	...
	public EList<ArrayDimension> getArrayDimensions() {
		if (arrayDimensions == null) {
			arrayDimensions = new EObjectContainmentEList<ArrayDimension>(ArrayDimension.class, this, DblPackage.CLASSIFIER__ARRAY_DIMENSIONS);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Type.class) {
			switch (derivedFeatureID) {
				case DblPackage.CLASSIFIER__ARRAY_DIMENSIONS: return DblPackage.TYPE__ARRAY_DIMENSIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Type.class) {
			switch (baseFeatureID) {
				case DblPackage.TYPE__ARRAY_DIMENSIONS: return DblPackage.CLASSIFIER__ARRAY_DIMENSIONS;
				default: return -1;
			}
		}
