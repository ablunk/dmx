 ...
 *   <li>{@link hub.sam.dbl.impl.TsRuleImpl#getPlaceHolder1 <em>Place Holder1</em>}</li>
 *   <li>{@link hub.sam.dbl.impl.TsRuleImpl#getPlaceHolder2 <em>Place Holder2</em>}</li>
 *   <li>{@link hub.sam.dbl.impl.TsRuleImpl#getPlaceHolder3 <em>Place Holder3</em>}</li>
 *   <li>{@link hub.sam.dbl.impl.TsRuleImpl#getPlaceHolder4 <em>Place Holder4</em>}</li>
 *   <li>{@link hub.sam.dbl.impl.TsRuleImpl#getPlaceHolder5 <em>Place Holder5</em>}</li>
 *   <li>{@link hub.sam.dbl.impl.TsRuleImpl#getPlaceHolder6 <em>Place Holder6</em>}</li>
 *   <li>{@link hub.sam.dbl.impl.TsRuleImpl#getPlaceHolder8 <em>Place Holder8</em>}</li>
 *   <li>{@link hub.sam.dbl.impl.TsRuleImpl#getPlaceHolder9 <em>Place Holder9</em>}</li>
 *   <li>{@link hub.sam.dbl.impl.TsRuleImpl#getPlaceHolder10 <em>Place Holder10</em>}</li>
...
public class TsRuleImpl extends NamedElementImpl implements TsRule {
	...
	public ExtensibleElement getPlaceHolder1() {
		if (placeHolder1 != null && ((EObject)placeHolder1).eIsProxy()) {
			...
			if (placeHolder1 != oldPlaceHolder1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DblPackage.TS_RULE__PLACE_HOLDER1, oldPlaceHolder1, placeHolder1));
			}
		}
		return placeHolder1;
	}
	...
	public void setPlaceHolder1(ExtensibleElement newPlaceHolder1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.TS_RULE__PLACE_HOLDER1, oldPlaceHolder1, placeHolder1));
	}
	...
	public ExtensibleElement getPlaceHolder2() {
		if (placeHolder2 != null && ((EObject)placeHolder2).eIsProxy()) {
			...
			if (placeHolder2 != oldPlaceHolder2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DblPackage.TS_RULE__PLACE_HOLDER2, oldPlaceHolder2, placeHolder2));
			}
		}
		return placeHolder2;
	}
	...
	public void setPlaceHolder2(ExtensibleElement newPlaceHolder2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.TS_RULE__PLACE_HOLDER2, oldPlaceHolder2, placeHolder2));
	}
	...
	public ExtensibleElement getPlaceHolder3() {
		if (placeHolder3 != null && ((EObject)placeHolder3).eIsProxy()) {
			...
			if (placeHolder3 != oldPlaceHolder3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DblPackage.TS_RULE__PLACE_HOLDER3, oldPlaceHolder3, placeHolder3));
			}
		}
		return placeHolder3;
	}
	...
	public void setPlaceHolder3(ExtensibleElement newPlaceHolder3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.TS_RULE__PLACE_HOLDER3, oldPlaceHolder3, placeHolder3));
	}
	...
	public ExtensibleElement getPlaceHolder4() {
		if (placeHolder4 != null && ((EObject)placeHolder4).eIsProxy()) {
			...
			if (placeHolder4 != oldPlaceHolder4) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DblPackage.TS_RULE__PLACE_HOLDER4, oldPlaceHolder4, placeHolder4));
			}
		}
		return placeHolder4;
	}
	...
	public void setPlaceHolder4(ExtensibleElement newPlaceHolder4) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.TS_RULE__PLACE_HOLDER4, oldPlaceHolder4, placeHolder4));
	}
	...
	public ExtensibleElement getPlaceHolder5() {
		if (placeHolder5 != null && ((EObject)placeHolder5).eIsProxy()) {
			...
			if (placeHolder5 != oldPlaceHolder5) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DblPackage.TS_RULE__PLACE_HOLDER5, oldPlaceHolder5, placeHolder5));
			}
		}
		return placeHolder5;
	}
	...
	public void setPlaceHolder5(ExtensibleElement newPlaceHolder5) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.TS_RULE__PLACE_HOLDER5, oldPlaceHolder5, placeHolder5));
	}
	...
	public ExtensibleElement getPlaceHolder6() {
		if (placeHolder6 != null && ((EObject)placeHolder6).eIsProxy()) {
			...
			if (placeHolder6 != oldPlaceHolder6) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DblPackage.TS_RULE__PLACE_HOLDER6, oldPlaceHolder6, placeHolder6));
			}
		}
		return placeHolder6;
	}
	...
	public void setPlaceHolder6(ExtensibleElement newPlaceHolder6) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.TS_RULE__PLACE_HOLDER6, oldPlaceHolder6, placeHolder6));
	}
	...
	public ExtensibleElement getPlaceHolder8() {
		if (placeHolder8 != null && ((EObject)placeHolder8).eIsProxy()) {
			...
			if (placeHolder8 != oldPlaceHolder8) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DblPackage.TS_RULE__PLACE_HOLDER8, oldPlaceHolder8, placeHolder8));
			}
		}
		return placeHolder8;
	}
	...
	public void setPlaceHolder8(ExtensibleElement newPlaceHolder8) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.TS_RULE__PLACE_HOLDER8, oldPlaceHolder8, placeHolder8));
	}
	...
	public ExtensibleElement getPlaceHolder9() {
		if (placeHolder9 != null && ((EObject)placeHolder9).eIsProxy()) {
			...
			if (placeHolder9 != oldPlaceHolder9) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DblPackage.TS_RULE__PLACE_HOLDER9, oldPlaceHolder9, placeHolder9));
			}
		}
		return placeHolder9;
	}
	...
	public void setPlaceHolder9(ExtensibleElement newPlaceHolder9) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.TS_RULE__PLACE_HOLDER9, oldPlaceHolder9, placeHolder9));
	}
	...
	public ExtensibleElement getPlaceHolder10() {
		if (placeHolder10 != null && ((EObject)placeHolder10).eIsProxy()) {
			...
			if (placeHolder10 != oldPlaceHolder10) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DblPackage.TS_RULE__PLACE_HOLDER10, oldPlaceHolder10, placeHolder10));
			}
		}
	...
	public void setPlaceHolder10(ExtensibleElement newPlaceHolder10) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.TS_RULE__PLACE_HOLDER10, oldPlaceHolder10, placeHolder10));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ExtensibleElement.class) {
			switch (derivedFeatureID) {
				...
				case DblPackage.TS_RULE__PLACE_HOLDER1: return DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER1;
				case DblPackage.TS_RULE__PLACE_HOLDER2: return DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER2;
				case DblPackage.TS_RULE__PLACE_HOLDER3: return DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER3;
				case DblPackage.TS_RULE__PLACE_HOLDER4: return DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER4;
				case DblPackage.TS_RULE__PLACE_HOLDER5: return DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER5;
				case DblPackage.TS_RULE__PLACE_HOLDER6: return DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER6;
				case DblPackage.TS_RULE__PLACE_HOLDER8: return DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER8;
				case DblPackage.TS_RULE__PLACE_HOLDER9: return DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER9;
				case DblPackage.TS_RULE__PLACE_HOLDER10: return DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER10;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ExtensibleElement.class) {
			switch (baseFeatureID) {
				...
				case DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER1: return DblPackage.TS_RULE__PLACE_HOLDER1;
				case DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER2: return DblPackage.TS_RULE__PLACE_HOLDER2;
				case DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER3: return DblPackage.TS_RULE__PLACE_HOLDER3;
				case DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER4: return DblPackage.TS_RULE__PLACE_HOLDER4;
				case DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER5: return DblPackage.TS_RULE__PLACE_HOLDER5;
				case DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER6: return DblPackage.TS_RULE__PLACE_HOLDER6;
				case DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER8: return DblPackage.TS_RULE__PLACE_HOLDER8;
				case DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER9: return DblPackage.TS_RULE__PLACE_HOLDER9;
				case DblPackage.EXTENSIBLE_ELEMENT__PLACE_HOLDER10: return DblPackage.TS_RULE__PLACE_HOLDER10;
				default: return -1;
			}
		}
		if (baseClass == LanguageConstructClassifier.class) {
