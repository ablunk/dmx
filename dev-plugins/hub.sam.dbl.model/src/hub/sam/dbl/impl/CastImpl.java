 ...
 *   <li>{@link hub.sam.dbl.impl.CastImpl#getArrayDimensions <em>Array Dimensions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CastImpl extends UnaryOperatorImpl implements Cast {
	...
	public EList<ArrayDimension> getArrayDimensions() {
		if (arrayDimensions == null) {
			arrayDimensions = new EObjectContainmentEList<ArrayDimension>(ArrayDimension.class, this, DblPackage.CAST__ARRAY_DIMENSIONS);
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			switch (derivedFeatureID) {
				...
				case DblPackage.CAST__ARRAY_DIMENSIONS: return DblPackage.TYPED_ELEMENT__ARRAY_DIMENSIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			switch (baseFeatureID) {
				...
				case DblPackage.TYPED_ELEMENT__ARRAY_DIMENSIONS: return DblPackage.CAST__ARRAY_DIMENSIONS;
				default: return -1;
			}
		}
