 ...
 * <ul>
 *   <li>{@link hub.sam.dbl.impl.CastImpl#getPrimitiveType <em>Primitive Type</em>}</li>
 *   <li>{@link hub.sam.dbl.impl.CastImpl#isIsList <em>Is List</em>}</li>
 *   <li>{@link hub.sam.dbl.impl.CastImpl#getListDims <em>List Dims</em>}</li>
 *   <li>{@link hub.sam.dbl.impl.CastImpl#getClassifierTypeExpr <em>Classifier Type Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CastImpl extends UnaryOperatorImpl implements Cast {
	...
	public NotificationChain basicSetPrimitiveType(PrimitiveType newPrimitiveType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DblPackage.CAST__PRIMITIVE_TYPE, oldPrimitiveType, newPrimitiveType);
	...
	public void setPrimitiveType(PrimitiveType newPrimitiveType) {
		if (newPrimitiveType != primitiveType) {
			...
			if (primitiveType != null)
				msgs = ((InternalEObject)primitiveType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DblPackage.CAST__PRIMITIVE_TYPE, null, msgs);
			if (newPrimitiveType != null)
				msgs = ((InternalEObject)newPrimitiveType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DblPackage.CAST__PRIMITIVE_TYPE, null, msgs);
			msgs = basicSetPrimitiveType(newPrimitiveType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.CAST__PRIMITIVE_TYPE, newPrimitiveType, newPrimitiveType));
	}
	...
	public void setIsList(boolean newIsList) {
		...
		isList = newIsList;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.CAST__IS_LIST, oldIsList, isList));
	}
	...
	public EList<ListDimension> getListDims() {
		if (listDims == null) {
			listDims = new EObjectContainmentEList<ListDimension>(ListDimension.class, this, DblPackage.CAST__LIST_DIMS);
		}
		return listDims;
	}
	...
	public NotificationChain basicSetClassifierTypeExpr(IdExpr newClassifierTypeExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DblPackage.CAST__CLASSIFIER_TYPE_EXPR, oldClassifierTypeExpr, newClassifierTypeExpr);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setClassifierTypeExpr(IdExpr newClassifierTypeExpr) {
		if (newClassifierTypeExpr != classifierTypeExpr) {
			...
			if (classifierTypeExpr != null)
				msgs = ((InternalEObject)classifierTypeExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DblPackage.CAST__CLASSIFIER_TYPE_EXPR, null, msgs);
			if (newClassifierTypeExpr != null)
				msgs = ((InternalEObject)newClassifierTypeExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DblPackage.CAST__CLASSIFIER_TYPE_EXPR, null, msgs);
			msgs = basicSetClassifierTypeExpr(newClassifierTypeExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DblPackage.CAST__CLASSIFIER_TYPE_EXPR, newClassifierTypeExpr, newClassifierTypeExpr));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			switch (derivedFeatureID) {
				case DblPackage.CAST__PRIMITIVE_TYPE: return DblPackage.TYPED_ELEMENT__PRIMITIVE_TYPE;
				case DblPackage.CAST__IS_LIST: return DblPackage.TYPED_ELEMENT__IS_LIST;
				case DblPackage.CAST__LIST_DIMS: return DblPackage.TYPED_ELEMENT__LIST_DIMS;
				case DblPackage.CAST__CLASSIFIER_TYPE_EXPR: return DblPackage.TYPED_ELEMENT__CLASSIFIER_TYPE_EXPR;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			switch (baseFeatureID) {
				case DblPackage.TYPED_ELEMENT__PRIMITIVE_TYPE: return DblPackage.CAST__PRIMITIVE_TYPE;
				case DblPackage.TYPED_ELEMENT__IS_LIST: return DblPackage.CAST__IS_LIST;
				case DblPackage.TYPED_ELEMENT__LIST_DIMS: return DblPackage.CAST__LIST_DIMS;
				case DblPackage.TYPED_ELEMENT__CLASSIFIER_TYPE_EXPR: return DblPackage.CAST__CLASSIFIER_TYPE_EXPR;
				default: return -1;
			}
		}
