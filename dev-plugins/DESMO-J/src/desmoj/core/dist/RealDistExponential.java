...
public class RealDistExponential extends RealDist {
	 ...
	 * @see desmoj.core.report.RealDistExponentialReporter
	 */
	public desmoj.core.report.Reporter createReporter() {

		return new desmoj.core.report.RealDistExponReporter(this);
	...
	public double sample() {
		...
		// there are no negative samples in RealDistExponential
		// if (nonNegative) {
