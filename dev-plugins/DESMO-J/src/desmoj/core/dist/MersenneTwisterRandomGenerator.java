...
/**
 * Mersenne twister uniform pseudo random generator configured such that a stream of 
 * [0,1] double values is produced. Implements the
 * <code>desmoj.dist.UniformRandomGenerator</code> interface. 
 * The algorithm for pseudo random number generation is based on the Mersenne twister 
 * variant MT19937 and has a period of 2<sup>19937</sup> - 1; see
 ...
 * @author Tim Lechler, Johannes Göbel
 * 
...
public class MersenneTwisterRandomGenerator implements
    ...
    /**
     * The repository for storing random numbers (which also denote
    ...
    public int nextInt(int bits) {
        ...
        if (currentIndex>623) this.twistNumbers();
