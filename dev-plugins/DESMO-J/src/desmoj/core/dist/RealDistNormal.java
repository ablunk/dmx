...
/**
 * Normally (also known as "Gaussian") distributed stream of pseudo random numbers
 * of type double. The algorithm used here is derived from the Java API class
 * <code>java.util.Random</code> and modified to also produce antithetic
 ...
 *
 */
public class RealDistNormal extends RealDist {
	 ...
	 * @see desmoj.core.report.RealDistNormalReporter
	 */
	public desmoj.core.report.Reporter createReporter() {

		return new desmoj.core.report.RealDistNormalReporter(this);
