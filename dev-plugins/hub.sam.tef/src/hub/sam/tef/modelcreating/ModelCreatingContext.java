...
public class ModelCreatingContext implements IModelCreatingContext {
	 ...
	 */
	protected final Map<EObject, ParseTreeRuleNode> fNodesForObjects = new HashMap<EObject, ParseTreeRuleNode>();
	...
	public ModelCreatingContext(EPackage[] packages, 
		...
		this(packages, semanticsProvider, resource, null, text);
	}
	/**
...
//			MyIterable<Object> rContents = new MyIterable<Object>((Iterator)getResource().getAllContents());
//			rLoop: for (Object o: rContents) {
//				System.out.println("getAllContents() includes " + o);
//				if (o instanceof EObject) {
//					EObject eo = (EObject) o;
//					if (eo.eClass().getName().equals("Import")) {
//						System.out.println("import");
//					}
//				}
//			}
		
//			System.out.println("#resources = " + resourceSet.getResources().size());
