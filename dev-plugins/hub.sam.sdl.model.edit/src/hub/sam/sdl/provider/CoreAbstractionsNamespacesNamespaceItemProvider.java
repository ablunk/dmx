...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.CoreAbstractionsNamespacesNamespace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CoreAbstractionsNamespacesNamespaceItemProvider
	 ...
	 * @generated
	 */
	public CoreAbstractionsNamespacesNamespaceItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CoreAbstractionsNamespacesNamespace)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CoreAbstractionsNamespacesNamespace_type") :
			getString("_UI_CoreAbstractionsNamespacesNamespace_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CoreAbstractionsNamespacesNamespace.class)) {
