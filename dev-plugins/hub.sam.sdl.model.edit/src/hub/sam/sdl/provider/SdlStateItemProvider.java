...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.SdlState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SdlStateItemProvider
	extends SdlNamedStateItemProvider
	implements
	 ...
	 * @generated
	 */
	public SdlStateItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SdlState"));
	}
	...
	public String getText(Object object) {
		String label = ((SdlState)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SdlState_type") :
			getString("_UI_SdlState_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SdlState.class)) {
