...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.CoreAbstractionsClassifiersFeature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CoreAbstractionsClassifiersFeatureItemProvider
	 ...
	 * @generated
	 */
	public CoreAbstractionsClassifiersFeatureItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CoreAbstractionsClassifiersFeature)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CoreAbstractionsClassifiersFeature_type") :
			getString("_UI_CoreAbstractionsClassifiersFeature_type") + " " + label;
	}
