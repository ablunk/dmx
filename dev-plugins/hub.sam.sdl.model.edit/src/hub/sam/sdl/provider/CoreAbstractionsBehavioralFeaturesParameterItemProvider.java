...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.CoreAbstractionsBehavioralFeaturesParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CoreAbstractionsBehavioralFeaturesParameterItemProvider
	 ...
	 * @generated
	 */
	public CoreAbstractionsBehavioralFeaturesParameterItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CoreAbstractionsBehavioralFeaturesParameter)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CoreAbstractionsBehavioralFeaturesParameter_type") :
			getString("_UI_CoreAbstractionsBehavioralFeaturesParameter_type") + " " + label;
	}
