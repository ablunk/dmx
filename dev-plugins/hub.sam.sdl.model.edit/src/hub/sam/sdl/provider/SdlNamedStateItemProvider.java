...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.SdlNamedState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SdlNamedStateItemProvider
	 ...
	 * @generated
	 */
	public SdlNamedStateItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SdlNamedState)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SdlNamedState_type") :
			getString("_UI_SdlNamedState_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SdlNamedState.class)) {
