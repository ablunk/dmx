...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.SdlLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SdlLiteralItemProvider
	extends EvaluationLiteralItemProvider
	implements
	 ...
	 * @generated
	 */
	public SdlLiteralItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SdlLiteral"));
	}
	...
	public String getText(Object object) {
		String label = ((SdlLiteral)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SdlLiteral_type") :
			getString("_UI_SdlLiteral_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SdlLiteral.class)) {
