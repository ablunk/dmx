...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.SdlPackage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SdlPackageItemProvider
	 ...
	 * @generated
	 */
	public SdlPackageItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EmfSdlPackage.eINSTANCE.getSdlPackage_NestedPackage());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SdlPackage"));
	}
	...
	public String getText(Object object) {
		String label = ((SdlPackage)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SdlPackage_type") :
			getString("_UI_SdlPackage_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SdlPackage.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlPackage_NestedPackage(),
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == EmfSdlPackage.eINSTANCE.getSdlPackage_NestedPackage();
