...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.SdlTimer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SdlTimerItemProvider
	extends SdlSignalItemProvider
	implements
	 ...
	 * @generated
	 */
	public SdlTimerItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SdlTimer"));
	}
	...
	public String getText(Object object) {
		String label = ((SdlTimer)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SdlTimer_type") :
			getString("_UI_SdlTimer_type") + " " + label;
	}
