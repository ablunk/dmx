...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.SdlOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SdlOperationItemProvider
	 ...
	 * @generated
	 */
	public SdlOperationItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EmfSdlPackage.eINSTANCE.getSdlOperation_Parameter());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SdlOperation"));
	}
	...
	public String getText(Object object) {
		String label = ((SdlOperation)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SdlOperation_type") :
			getString("_UI_SdlOperation_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SdlOperation.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlOperation_Parameter(),
				 EmfSdlFactory.eINSTANCE.createSdlParameter()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == EmfSdlPackage.eINSTANCE.getSdlOperation_Parameter();
