...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.SdlNamespace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SdlNamespaceItemProvider
	 ...
	 * @generated
	 */
	public SdlNamespaceItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SdlNamespace)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SdlNamespace_type") :
			getString("_UI_SdlNamespace_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SdlNamespace.class)) {
