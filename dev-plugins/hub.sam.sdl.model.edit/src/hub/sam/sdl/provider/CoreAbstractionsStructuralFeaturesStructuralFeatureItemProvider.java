...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.CoreAbstractionsStructuralFeaturesStructuralFeature} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CoreAbstractionsStructuralFeaturesStructuralFeatureItemProvider
	 ...
	 * @generated
	 */
	public CoreAbstractionsStructuralFeaturesStructuralFeatureItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CoreAbstractionsStructuralFeaturesStructuralFeature)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CoreAbstractionsStructuralFeaturesStructuralFeature_type") :
			getString("_UI_CoreAbstractionsStructuralFeaturesStructuralFeature_type") + " " + label;
	}
