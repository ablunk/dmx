...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.CommunicationEventType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommunicationEventTypeItemProvider
	 ...
	 * @generated
	 */
	public CommunicationEventTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CommunicationEventType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CommunicationEventType_type") :
			getString("_UI_CommunicationEventType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CommunicationEventType.class)) {
