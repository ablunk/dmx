...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.CoreAbstractionsTypedElementsTypedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CoreAbstractionsTypedElementsTypedElementItemProvider
	 ...
	 * @generated
	 */
	public CoreAbstractionsTypedElementsTypedElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CoreAbstractionsTypedElementsTypedElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CoreAbstractionsTypedElementsTypedElement_type") :
			getString("_UI_CoreAbstractionsTypedElementsTypedElement_type") + " " + label;
	}
