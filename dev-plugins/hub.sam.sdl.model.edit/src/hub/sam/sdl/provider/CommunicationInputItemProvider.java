...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.CommunicationInput} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommunicationInputItemProvider
	extends CoreAbstractionsClassifiersFeatureItemProvider
	implements
	 ...
	 * @generated
	 */
	public CommunicationInputItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CommunicationInput)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CommunicationInput_type") :
			getString("_UI_CommunicationInput_type") + " " + label;
	}
