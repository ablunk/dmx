...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.CoreAbstractionsClassifiersClassifier} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CoreAbstractionsClassifiersClassifierItemProvider
	 ...
	 * @generated
	 */
	public CoreAbstractionsClassifiersClassifierItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CoreAbstractionsClassifiersClassifier)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CoreAbstractionsClassifiersClassifier_type") :
			getString("_UI_CoreAbstractionsClassifiersClassifier_type") + " " + label;
	}
