...
/**
 * This is the item provider adapter for a {@link hub.sam.sdl.SdlStateAutomaton} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SdlStateAutomatonItemProvider
	extends SdlBehaviorItemProvider
	implements
	 ...
	 * @generated
	 */
	public SdlStateAutomatonItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_State());
			childrenFeatures.add(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_Transition());
			childrenFeatures.add(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_NamedState());
			childrenFeatures.add(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_Start());
		}
	...
	/**
	 * This returns SdlStateAutomaton.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SdlStateAutomaton"));
	}
	...
	public String getText(Object object) {
		String label = ((SdlStateAutomaton)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SdlStateAutomaton_type") :
			getString("_UI_SdlStateAutomaton_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SdlStateAutomaton.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_State(),
				 EmfSdlFactory.eINSTANCE.createSdlState()));
		...
		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_State(),
				 EmfSdlFactory.eINSTANCE.createFork()));

		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_State(),
				 EmfSdlFactory.eINSTANCE.createStart()));

		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_State(),
				 EmfSdlFactory.eINSTANCE.createHistory()));

		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_State(),
				 EmfSdlFactory.eINSTANCE.createJoin()));

		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_State(),
				 EmfSdlFactory.eINSTANCE.createStop()));

		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_State(),
				 EmfSdlFactory.eINSTANCE.createReturn()));
		...
		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_State(),
				 EmfSdlFactory.eINSTANCE.createSdlSplit()));

		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_State(),
				 EmfSdlFactory.eINSTANCE.createSdlStateNode()));
		...
		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_Transition(),
				 EmfSdlFactory.eINSTANCE.createSdlTransition()));

		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_NamedState(),
				 EmfSdlFactory.eINSTANCE.createSdlState()));
		...
		newChildDescriptors.add
			(createChildParameter
				(EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_Start(),
				 EmfSdlFactory.eINSTANCE.createStart()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_State() ||
			childFeature == EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_NamedState() ||
			childFeature == EmfSdlPackage.eINSTANCE.getCoreAbstractionsOwnershipsElement_OwnedComment() ||
			childFeature == EmfSdlPackage.eINSTANCE.getSdlStateAutomaton_Start();
