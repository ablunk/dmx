...
public final class JistAPI_Impl extends JistAPI {
	...
	static {
		try {
			...
			method_run = JistAPI_Impl.class.getDeclaredMethod("run", new Class[] { Integer.TYPE, String.class, String[].class,
					Object.class });
	...
	public static void sleepBlock(long i) throws JistAPI.Continuable {
		try {
			if (i > 0) {
				...
				Controller.entityInvocationContWaiting(BlockingSleep._jistMethodStub_sleep_28J_29V,
						Controller.getActiveController().entityBlockingSleep._jistMethod_Get__ref(),
						new Object[] { new Long(i) });
			}
		} catch (Throwable e) {
