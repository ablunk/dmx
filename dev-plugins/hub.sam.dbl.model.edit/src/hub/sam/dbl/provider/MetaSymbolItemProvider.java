...
/**
 * This is the item provider adapter for a {@link hub.sam.dbl.MetaSymbol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetaSymbolItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MetaSymbolItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DblPackage.Literals.META_SYMBOL__POSSIBLE_SYNTAX);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MetaSymbol"));
	}
	...
	public String getText(Object object) {
		String label = ((MetaSymbol)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MetaSymbol_type") :
			getString("_UI_MetaSymbol_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MetaSymbol.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DblPackage.Literals.META_SYMBOL__POSSIBLE_SYNTAX,
				 DblFactory.eINSTANCE.createSyntaxExpression()));

		newChildDescriptors.add
			(createChildParameter
				(DblPackage.Literals.META_SYMBOL__POSSIBLE_SYNTAX,
				 DblFactory.eINSTANCE.createL3SyntaxExpression()));

		newChildDescriptors.add
			(createChildParameter
				(DblPackage.Literals.META_SYMBOL__POSSIBLE_SYNTAX,
				 DblFactory.eINSTANCE.createL2SyntaxExpression()));

		newChildDescriptors.add
			(createChildParameter
				(DblPackage.Literals.META_SYMBOL__POSSIBLE_SYNTAX,
				 DblFactory.eINSTANCE.createSymbolSequence()));

		newChildDescriptors.add
			(createChildParameter
				(DblPackage.Literals.META_SYMBOL__POSSIBLE_SYNTAX,
				 DblFactory.eINSTANCE.createL1SyntaxExpression()));

		newChildDescriptors.add
			(createChildParameter
				(DblPackage.Literals.META_SYMBOL__POSSIBLE_SYNTAX,
				 DblFactory.eINSTANCE.createStructuralSymbolReference()));

		newChildDescriptors.add
			(createChildParameter
				(DblPackage.Literals.META_SYMBOL__POSSIBLE_SYNTAX,
				 DblFactory.eINSTANCE.createPlainSymbolReference()));
	}
