...
/**
 * This is the item provider adapter for a {@link hub.sam.dbl.SetStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SetStatementItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DblPackage.Literals.SET_STATEMENT__OBJECT);
			childrenFeatures.add(DblPackage.Literals.SET_STATEMENT__SET);
		}
	...
	public String getText(Object object) {
		String label = ((SetStatement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SetStatement_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SetStatement.class)) {
			case DblPackage.SET_STATEMENT__OBJECT:
			case DblPackage.SET_STATEMENT__SET:
