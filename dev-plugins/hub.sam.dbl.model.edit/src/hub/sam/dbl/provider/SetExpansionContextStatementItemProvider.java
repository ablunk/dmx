...
/**
 * This is the item provider adapter for a {@link hub.sam.dbl.SetExpansionContextStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SetExpansionContextStatementItemProvider extends SimpleStatementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SetExpansionContextStatementItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SetExpansionContextStatement_addAfterContext_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SetExpansionContextStatement_addAfterContext_feature", "_UI_SetExpansionContextStatement_type"),
				 DblPackage.Literals.SET_EXPANSION_CONTEXT_STATEMENT__ADD_AFTER_CONTEXT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DblPackage.Literals.SET_EXPANSION_CONTEXT_STATEMENT__CONTEXT);
		}
	...
	/**
	 * This returns SetExpansionContextStatement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SetExpansionContextStatement"));
	}
	...
	public String getText(Object object) {
		String label = ((SetExpansionContextStatement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SetExpansionContextStatement_type") :
			getString("_UI_SetExpansionContextStatement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SetExpansionContextStatement.class)) {
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == DblPackage.Literals.SET_EXPANSION_CONTEXT_STATEMENT__CONTEXT;
