...
/**
 * This is the item provider adapter for a {@link hub.sam.dbl.CompositeStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CompositeStatementItemProvider
	...
	public String getText(Object object) {
		String label = ((CompositeStatement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CompositeStatement_type") :
			getString("_UI_CompositeStatement_type") + " " + label;
	}
