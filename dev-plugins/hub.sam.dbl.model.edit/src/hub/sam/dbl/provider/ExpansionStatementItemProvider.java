...
/**
 * This is the item provider adapter for a {@link hub.sam.dbl.ExpansionStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExpansionStatementItemProvider extends StatementItemProvider {
	 ...
	 * @generated
	 */
	public ExpansionStatementItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns ExpansionStatement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExpansionStatement"));
	}
	...
	public String getText(Object object) {
		String label = ((ExpansionStatement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ExpansionStatement_type") :
			getString("_UI_ExpansionStatement_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DblPackage.Literals.EXPANSION_STATEMENT__PARTS,
				 DblFactory.eINSTANCE.createExpandTextPart()));

		newChildDescriptors.add
			(createChildParameter
				(DblPackage.Literals.EXPANSION_STATEMENT__PARTS,
				 DblFactory.eINSTANCE.createExpandVariablePart()));
