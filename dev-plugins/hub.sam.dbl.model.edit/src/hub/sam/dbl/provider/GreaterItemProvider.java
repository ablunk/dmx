...
/**
 * This is the item provider adapter for a {@link hub.sam.dbl.Greater} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GreaterItemProvider extends BinaryOperatorItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Greater)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Greater_type") :
			getString("_UI_Greater_type") + " " + label;
	}
