...
/**
 * This is the item provider adapter for a {@link hub.sam.dbl.ExtensionSemantics} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExtensionSemanticsItemProvider extends ExtensibleElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ExtensionSemanticsItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ExtensionSemantics_syntaxDefinition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ExtensionSemantics_syntaxDefinition_feature", "_UI_ExtensionSemantics_type"),
				 DblPackage.Literals.EXTENSION_SEMANTICS__SYNTAX_DEFINITION,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns ExtensionSemantics.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ExtensionSemantics"));
	}
	...
	public String getText(Object object) {
		String label = ((ExtensionSemantics)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ExtensionSemantics_type") :
			getString("_UI_ExtensionSemantics_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ExtensionSemantics.class)) {
