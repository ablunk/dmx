...
/**
 * This is the item provider adapter for a {@link hub.sam.dbl.MetaExpr} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MetaExprItemProvider extends ExpressionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MetaExprItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DblPackage.Literals.META_EXPR__EXPR);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MetaExpr"));
	}
	...
	public String getText(Object object) {
		String label = ((MetaExpr)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MetaExpr_type") :
			getString("_UI_MetaExpr_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MetaExpr.class)) {
