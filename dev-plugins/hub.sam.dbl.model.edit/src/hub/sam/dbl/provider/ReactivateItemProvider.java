...
/**
 * This is the item provider adapter for a {@link hub.sam.dbl.Reactivate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReactivateItemProvider extends SimpleStatementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ReactivateItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DblPackage.Literals.REACTIVATE__OBJECT_ACCESS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Reactivate"));
	}
	...
	public String getText(Object object) {
		String label = ((Reactivate)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Reactivate_type") :
			getString("_UI_Reactivate_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Reactivate.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DblPackage.Literals.REACTIVATE__OBJECT_ACCESS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == DblPackage.Literals.REACTIVATE__OBJECT_ACCESS;
