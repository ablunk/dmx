...
/**
 * This is the item provider adapter for a {@link hub.sam.edu.modsoft.bfmodel.bf.Box} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BoxItemProvider
	...
	protected void addIncomingFlowsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Box_incomingFlows_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Box_incomingFlows_feature", "_UI_Box_type"),
				 BfPackage.Literals.BOX__INCOMING_FLOWS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutgoingFlowsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Box_outgoingFlows_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Box_outgoingFlows_feature", "_UI_Box_type"),
				 BfPackage.Literals.BOX__OUTGOING_FLOWS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BfPackage.Literals.BOX__OWNED_BOXES);
			childrenFeatures.add(BfPackage.Literals.BOX__FLOWS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BfPackage.Literals.BOX__OWNED_BOXES,
				 BfFactory.eINSTANCE.createBox()));

		newChildDescriptors.add
			(createChildParameter
				(BfPackage.Literals.BOX__FLOWS,
				 BfFactory.eINSTANCE.createFlow()));
	}
